...
import { GLASSES } from '../tryon/GlassesSelector';
...
const TryOnOverlay = () => {
    ...
    // Single source of truth — reuse the same GLASSES from GlassesSelector
    const glassesOptions = GLASSES.map((g) => ({ label: g.label, url: g.src }));
